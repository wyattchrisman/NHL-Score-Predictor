...
```
The above graph and tibble show that our most accurate option is a normalized data set with a k value of 37. These values will now be used to to create a confusion matrix for c
