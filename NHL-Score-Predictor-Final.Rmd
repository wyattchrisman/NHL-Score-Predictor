...
data_quantitative <- data |> 
  ...
  select(totalGoals:highDangerGoalsAgainst, -OU) 
  # mutate(
...
```
We'll use a line graph and slice function to decide our 
...
```
The above graph and tibble show that our most accurate option is a normalized data set with a k value of 37.
